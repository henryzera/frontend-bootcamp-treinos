  ...
  return (
    <div className="flex min-h-svh flex-col bg-background pb-24 lg:pb-10 lg:pl-72">
      <div className="w-full md:px-6 lg:px-10">
        <div className="relative flex h-[296px] shrink-0 flex-col items-start justify-between overflow-hidden rounded-b-[20px] px-5 pb-10 pt-5 md:mx-auto md:mt-6 md:h-[360px] md:max-w-6xl md:rounded-3xl md:px-8 lg:h-[420px]">
          ...
          <div className="relative flex w-full items-end justify-between">
            <div className="flex flex-col gap-1.5">
              <h1 className="font-heading text-2xl font-semibold leading-[1.05] text-background md:text-3xl">
                Olá, {userName}
              </h1>
              <p className="font-heading text-sm leading-[1.15] text-background/70 md:text-base">
                Bora treinar hoje?
              </p>
            </div>
            <div className="rounded-full bg-primary px-4 py-2 md:px-5 md:py-2.5">
              <span className="font-heading text-sm font-semibold text-primary-foreground md:text-base">
                Bora!
              </span>
            </div>
          </div>
      ...
      <div className="w-full md:mx-auto md:max-w-6xl md:px-6 lg:px-10">
        <div className="grid gap-5 px-5 pt-5 md:px-0 md:pt-6 lg:grid-cols-12 lg:gap-6">
          <section
            className={`flex flex-col gap-3 ${
              todayWorkoutDay ? "lg:col-span-5" : "lg:col-span-12"
            }`}
          >
