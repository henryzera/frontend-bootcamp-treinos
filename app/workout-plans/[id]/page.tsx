  ...
  return (
    <div className="flex min-h-svh flex-col bg-background pb-24 lg:pb-10 lg:pl-72">
      <div className="w-full md:px-6 lg:px-10">
        <div className="relative flex h-74 shrink-0 flex-col items-start justify-between overflow-hidden rounded-b-4xl px-5 pb-10 pt-5 md:mx-auto md:mt-6 md:h-80 md:max-w-6xl md:rounded-3xl md:px-8">
      ...
      <div className="w-full md:mx-auto md:max-w-6xl md:px-6 lg:px-10">
        <div className="grid gap-3 p-5 md:grid-cols-2 md:px-0 md:pt-6 lg:gap-4">
          {sortedDays.map((day) =>
            day.isRest ? (
